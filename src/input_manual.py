...
if __name__ == "__main__":
    while True:
        print("========== 手動資料建檔系統 ==========")
        print("1. 輸入 [金控每月自結盈餘] (每月查新聞)(一般到損益表切標籤單季/累季)")
        print("2. 輸入 [歷年股利與盈餘_至少7年] (查股利政策)(財務比率表)")
        print("3. 輸入 [歷年總營收_前一年度] (損益表-營業收入)")  
        print("4. 輸入 [歷年本益比極值_至少7年] (本益比河流圖)") 
        print("5. 輸入 [歷年殖利率_至少7年] (股利政策)")
        print("6. 離開程式")
        print("======================================")
